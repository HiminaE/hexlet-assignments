...
class AppTest {
    ...
    void testReversedSequence() {
        CharSequence str = new ReversedSequence("polindrom");
        assertThat(str.toString()).isEqualTo("mordnilop");
        assertThat(str.length()).isEqualTo(9);
        assertThat(str.charAt(2)).isEqualTo('r');
        assertThat(str.subSequence(1, 4)).isEqualTo("ord");
    }
    // END
}
